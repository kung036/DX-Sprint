...
import com.example.tour.src.home.detail.DetailFragment
import java.net.URL
import java.util.*
...
class MainAdapter(private val dataSet: ArrayList<CardClass>, private val context: Context, private var mainActivity: MainActivity): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
